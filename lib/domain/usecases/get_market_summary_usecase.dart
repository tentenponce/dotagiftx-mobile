...
class GetMarketSummaryUsecaseImpl implements GetMarketSummaryUsecase {
  final DotagiftxUnauthApi _dotagiftxApi;
  final KeychainStorage _keychainStorage;

  GetMarketSummaryUsecaseImpl(this._dotagiftxApi, this._keychainStorage);
  ...
  Future<MarketSummaryModel> get() async {
    ...
    final futurePartnerSummary = _dotagiftxApi.getMarketSummary(steamId, '');
    final futureUserSummary = _dotagiftxApi.getMarketSummary('', userId);
