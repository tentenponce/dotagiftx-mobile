...
class CancelledItemView extends StatelessWidget {
  final MarketListingModel listing;
  const CancelledItemView({required this.listing, super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              Text(
                                I18n.of(context).cancelledItemViewCancelled,
                                style: const TextStyle(
                        ...
                        NavigatorUtils.showPageModalBottomSheet<void>(
                          ...
                          UserDetailWebviewView(
                            ...
                            title:
                                I18n.of(
                                  context,
                                ).cancelledItemViewViewBuyerProfile,
                            pageName: PageName.cancelledItemProfile,
                          ),
                        ),
                      ),
                ),
