...
import 'get_my_listings_usecase_test.mocks.dart';

@GenerateNiceMocks([MockSpec<DotagiftxAuthApi>()])
void main() {
  group(GetMyListingsUsecaseImpl, () {
    late MockDotagiftxAuthApi mockDotagiftxAuthApi;
    late GetMyListingsUsecaseImpl usecase;
    ...
    setUp(() {
      ...
      usecase = GetMyListingsUsecaseImpl(mockDotagiftxAuthApi);
    });
    ...
    group('get', () {
      ...
      test('should return my listings with custom parameters', () async {
        ...
        const customPage = 2;
        const customStatus = ApiConstants.queryMarketStatusLive;
